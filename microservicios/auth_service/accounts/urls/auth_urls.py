...
from ..views.auth_views import LoginView, LogoutView, user_info, RegistroClienteView

from ..views.solicitar_codigo_view import SolicitarCodigoRecuperacionView
from ..views.auth_views  import ConfirmarCodigoRecuperacionView
from ..views.auth_views  import cambiar_password  
